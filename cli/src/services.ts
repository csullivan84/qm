  ...
  core: {
    ...
    fly: {
      ...
      stackKeys: [
        ...
        "LOCAL_AUTH_SESSION_TTL_SEC",
        "LOCAL_AUTH_RESET_TTL_SEC",
        "S3_BUCKET",
        "S3_REGION",
        "PUBLIC_WEB_URL",
        "FLY_ORG",
  ...
  portal: {
    ...
    fly: {
      ...
      stackKeys: [
        "PORTAL_PUBLIC_URL",
        "PORTAL_AUTH_MODE",
        "PORTAL_LOCAL_AUTH_LOGIN_LIMIT_PER_USER",
        "PORTAL_LOCAL_AUTH_LOGIN_LIMIT_PER_IP",
        "PORTAL_LOCAL_AUTH_LOGIN_WINDOW_S",
        "OIDC_CLIENT_ID",
        "OIDC_ALLOWED_EMAILS",
        "OIDC_ALLOWED_EMAIL_DOMAIN",
