...
import { deleteMatrixInstallation, getMatrixInstallation, putMatrixInstallation } from "./admin/matrix-installation.ts";
import { deleteModelProvider, getModelProviders, putModelProvider } from "./admin/model-providers.ts";
import {
  acknowledgeBackupRecoveryKit,
  deleteBackupConfig,
  getBackupConfig,
  getBackupRun,
  getBackupStatus,
  issueBackupRecoveryKit,
  listBackupAudit,
  listBackupRuns,
  listRecoveryPoints,
  listRestoreDrills,
...
const routes: ReadonlyArray<Route<ApiCtx>> = [
  ...
  { method: "GET", path: "/v1/admin/matrix-installation", auth: "either", handle: getMatrixInstallation },
  { method: "PUT", path: "/v1/admin/matrix-installation", auth: "either", handle: putMatrixInstallation },
  { method: "DELETE", path: "/v1/admin/matrix-installation", auth: "either", handle: deleteMatrixInstallation },
  { method: "GET", path: "/v1/admin/backups/status", auth: "either", handle: getBackupStatus },
  { method: "GET", path: "/v1/admin/backups/config", auth: "either", handle: getBackupConfig },
  { method: "PUT", path: "/v1/admin/backups/config", auth: "either", handle: putBackupConfig },
  { method: "DELETE", path: "/v1/admin/backups/config", auth: "either", handle: deleteBackupConfig },
  { method: "POST", path: "/v1/admin/backups/test-destination", auth: "either", handle: testBackupDestination },
  { method: "POST", path: "/v1/admin/backups/recovery-kit", auth: "either", handle: issueBackupRecoveryKit },
  {
    method: "POST",
    path: "/v1/admin/backups/recovery-kit/acknowledge",
    auth: "either",
    handle: acknowledgeBackupRecoveryKit,
  },
  { method: "GET", path: "/v1/admin/backups/runs", auth: "either", handle: listBackupRuns },
  { method: "POST", path: "/v1/admin/backups/runs", auth: "either", handle: requestBackupRun },
  { method: "GET", path: "/v1/admin/backups/runs/:id", auth: "either", handle: getBackupRun },
  { method: "POST", path: "/v1/admin/backups/runs/:id/retry", auth: "either", handle: retryBackupRun },
  { method: "GET", path: "/v1/admin/backups/recovery-points", auth: "either", handle: listRecoveryPoints },
  {
    method: "POST",
    path: "/v1/admin/backups/recovery-points/:id/verify",
    auth: "either",
    handle: requestRestoreDrill,
  },
  {
    method: "POST",
    path: "/v1/admin/backups/recovery-points/:id/restore-drill",
    auth: "either",
    handle: requestRestoreDrill,
  },
  {
    method: "POST",
    path: "/v1/admin/backups/recovery-points/:id/prepare-recovery",
    auth: "either",
    handle: prepareBackupRecovery,
  },
  { method: "GET", path: "/v1/admin/backups/restore-drills", auth: "either", handle: listRestoreDrills },
  { method: "POST", path: "/v1/admin/backups/suspend", auth: "either", handle: suspendBackups },
  { method: "POST", path: "/v1/admin/backups/resume", auth: "either", handle: resumeBackups },
  { method: "GET", path: "/v1/admin/backups/audit", auth: "either", handle: listBackupAudit },
  ...
  { method: "POST", path: "/v1/admin/local-users", auth: "either", handle: createLocalUser },
  {
    method: "PUT",
    path: "/v1/admin/local-users/:username/password",
    auth: "either",
    handle: setLocalUserPassword,
  },
  {
    method: "POST",
    path: "/v1/admin/local-users/:username/password-reset",
    auth: "either",
    handle: resetLocalUserPassword,
  },
  {
    method: "PUT",
    path: "/v1/admin/local-users/:username/enabled",
    auth: "either",
    handle: setLocalUserEnabled,
  },
