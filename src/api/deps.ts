...
import type { MatrixInstallationStore } from "../surfaces/matrix-installation.ts";
import type { BackupService } from "../backup/service.ts";
import type { LocalAuthService } from "../auth/local-auth.ts";
...
export interface ServerDeps {
  ...
  matrixInstallationFetch?: typeof fetch;
  matrixEnvironmentState?: "absent" | "configured" | "partial";
  matrixSyncCursorPath?: string;
