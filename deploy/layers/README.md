...
In public QM this directory holds nothing but this file, and it stays that way. A layer
belongs to one organization's private downstream and never travels to a public repository.
The `update-qm` skill merges inbound source updates around that boundary.
